  ...
  return (
    ...
    <div className='hidden sm:flex flex-row justify-between text-custom-black'>
      ...
      <p className='titulo_general'>Personas</p>
        ...
        >
          <button
            className='hidden sm:flex p-2 items-center hover:bg-[#ff7300] rounded-full transition w-8 h-8'
        ...
        <table className='w-full text-[#1A1A1A]'>
          <thead>
            <tr className='text-left'>
              <th className='bg-degradado min-w-[168px] rounded-tl-lg sm:rounded-tl-md px-5 py-2'>
                Nombres
              </th>
              <th className='bg-degradado px-5 py-2'>Apellidos</th>
              <th className='bg-degradado px-5 py-2'>Fecha de Nacimiento</th>
              <th className='bg-degradado px-5 py-2'>Sexo</th>
              <th className='bg-degradado px-5 py-2'>Tipo de Documento</th>
              <th className='bg-degradado px-5 py-2'>Tipo de Persona</th>
              <th className='bg-degradado px-5 py-2'>Estado Civil</th>
              <th className='bg-degradado px-5 py-2'>Ciudad</th>
              <th className='bg-degradado text-center'>
                Nacionalidad
              </th>
              <th className='bg-degradado rounded-tr-lg sm:rounded-tr-md px-5 py-2 text-center'>Acciones</th>
            </tr>
          </thead>
