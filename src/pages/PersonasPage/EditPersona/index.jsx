...
import { serviceEditPerson } from '../../../services/personas/personas';
...
export const EditPersona = () => {
  ...
  useEffect(() => {
    // Aquí deberías cargar los datos de la persona con el id correspondiente
    // y establecerlos en el estado local 'form'.
  }, [id]);
  ...
  const handleUpdate = async (e) => {
    e.preventDefault();
    try {
      // Aquí deberías enviar la solicitud para actualizar la persona con los datos del formulario.
      await serviceEditPerson(form);
      navigate('/personas');
    } catch (err) {
      console.log(err);
    }
